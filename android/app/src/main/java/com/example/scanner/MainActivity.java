...
import com.example.scanner.utils.SharedPrefsUtils;
import com.example.scanner.utils.adx.Config;
                    ...
                    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
                        ...
                        switch (call.method) {
                            ...
                            case "moveToNewApp":
                                ...
                                break;
                            case "getAppIdAds":
//                                result.success(com.example.scanner.utils.adx.SharedPrefsUtils.getInstance(MainActivity.this).getString());
                                break;
                            case "getIdBanner":
                                result.success(com.example.scanner.utils.adx.SharedPrefsUtils.getInstance(MainActivity.this).getString(Config.AD_BANNER));
                                break;
                            case "getIdInter":
                                result.success(com.example.scanner.utils.adx.SharedPrefsUtils.getInstance(MainActivity.this).getString(Config.AD_INTERSTITIAL));
                                break;
                        }
